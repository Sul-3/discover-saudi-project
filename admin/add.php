...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    mysqli_stmt_bind_param($stmt, "sssssssssss", $name, $category, $short_description, $description, $history, $culture, $landmarks, $main_image, $image_one, $image_two, $image_three);
